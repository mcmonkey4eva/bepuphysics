namespace BEPUphysics.Settings
{
    ...
    public static class CollisionResponseSettings
    {
        ...
        /// Defaults to 1.
        /// </summary>
        public static double BouncinessVelocityThreshold = 1;

        /// <summary>
        /// Maximum speed at which interpenetrating objects will attempt to undo any overlap.
        /// Defaults to 2.
        /// </summary>
        public static double MaximumPenetrationRecoverySpeed = 2;

        /// <summary>
        /// Fraction of position error to convert into corrective momentum.
        /// Defaults to 0.2.
        /// </summary>
        public static double PenetrationRecoveryStiffness = 0.2f;
        ...
        /// </summary>
        public static double Softness = .001f;

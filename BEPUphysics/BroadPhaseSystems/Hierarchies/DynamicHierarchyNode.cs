...
namespace BEPUphysics.BroadPhaseSystems.Hierarchies
{
    internal abstract class Node
    {
        ...
        internal abstract void GetOverlaps(ref Ray ray, double maximumLength, IList<BroadPhaseEntry> outputOverlappedElements);
        ...
        internal abstract double MeasureSubtreeCost();
    }
    ...
    internal sealed class InternalNode : Node
    {
        ...
        internal double maximumVolume;

        internal static double MaximumVolumeScale = 1.4f;
        ...
        internal override void GetOverlaps(ref Ray ray, double maximumLength, IList<BroadPhaseEntry> outputOverlappedElements)
        {
            double result;
        ...
        internal override bool TryToInsert(LeafNode node, out Node treeNode)
        {
            ...
            Vector3 offset;
            double originalAVolume, originalBVolume;
            ...
            double mergedAVolume, mergedBVolume;
        ...
        internal override void Refit()
        {
            ...
            //double DEBUGlastVolume = currentVolume;
        ...
        internal override double MeasureSubtreeCost()
        {
            Vector3 offset;
            Vector3.Subtract(ref BoundingBox.Max, ref BoundingBox.Min, out offset);

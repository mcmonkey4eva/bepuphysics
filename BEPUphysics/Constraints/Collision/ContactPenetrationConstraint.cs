...
namespace BEPUphysics.Constraints.Collision
{
    ...
    public class ContactPenetrationConstraint : SolverUpdateable
    {
        ...
        public override void Update(double dt)
        {
            ...
            double effectiveMassInverse = entryA + entryB;
            ...
            if (contact.PenetrationDepth >= 0)
            {
                ...
                if (contactManifoldConstraint.materialInteraction.Bounciness > 0)
                {
                    ...
                    double bounceVelocity = -RelativeVelocity;
                    if (bounceVelocity > 0)
                    {
            ...
            else
            {
                ...
                //    double relativeVelocity = -RelativeVelocity;
        ...
        public override double SolveIteration()
        {
            ...
            double lambda = (RelativeVelocity - bias + softness * accumulatedImpulse) * velocityToImpulse;

...
namespace BEPUphysics.Constraints.TwoEntity.JointLimits
{
    ...
    public class RevoluteLimit : JointLimit, I2DImpulseConstraintWithError, I2DJacobianConstraint
    {
        ...
        public RevoluteLimit(Entity connectionA, Entity connectionB, Vector3 limitedAxis, Vector3 testAxis, double minimumAngle, double maximumAngle)
        {
        ...
        public override double SolveIteration()
        {
            ...
            double velocityA, velocityB;
            double previousAccumulatedImpulse;
            if (minIsActive)
            {
        ...
        public override void Update(double dt)
        {
            ...
            double planePositionMin, planePositionMax;
            ...
            double span = GetDistanceFromMinimum(maximumAngle);
            ...
            double minEntryA, minEntryB;
            double maxEntryA, maxEntryB;

...
namespace BEPUphysics.Constraints.TwoEntity.JointLimits
{
    ...
    public abstract class JointLimit : Joint
    {
        ...
        /// </summary>
        protected double bounceVelocityThreshold = 1;
        ...
        protected double ComputeBounceVelocity(double impactVelocity)
        {

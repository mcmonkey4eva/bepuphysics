namespace BEPUphysics.Paths
{
    ...
    public abstract class VariableSpeedCurve<TValue> : SpeedControlledCurve<TValue>
    {
        ...
        protected VariableSpeedCurve(Path<double> speedCurve, Curve<TValue> curve)
            : base(curve)
        {
        ...
        protected VariableSpeedCurve(Path<double> speedCurve, Curve<TValue> curve, int sampleCount)
        ...
        /// </summary>
        public Path<double> SpeedCurve { get; set; }

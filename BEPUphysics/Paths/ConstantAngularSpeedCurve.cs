...
namespace BEPUphysics.Paths
{
    ...
    public class ConstantAngularSpeedCurve : ConstantSpeedCurve<Quaternion>
    {
        ...
        public ConstantAngularSpeedCurve(double speed, Curve<Quaternion> curve)
            : base(speed, curve)
        {
        }
        ...
        public ConstantAngularSpeedCurve(double speed, Curve<Quaternion> curve, int sampleCount)

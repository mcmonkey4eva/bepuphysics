...
namespace BEPUphysics.Paths
{
    ...
    public class VariableAngularSpeedCurve : VariableSpeedCurve<Quaternion>
    {
        ...
        public VariableAngularSpeedCurve(Path<double> speedCurve, Curve<Quaternion> curve)
        ...
        public VariableAngularSpeedCurve(Path<double> speedCurve, Curve<Quaternion> curve, int sampleCount)
            : base(speedCurve, curve, sampleCount)
        {
        }

        protected override double GetDistance(Quaternion start, Quaternion end)
        {

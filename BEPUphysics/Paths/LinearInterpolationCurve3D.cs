...
namespace BEPUphysics.Paths
{
    ...
    public class LinearInterpolationCurve3D : Curve<Vector3>
    {
        ...
        public override void Evaluate(int controlPointIndex, double weight, out Vector3 value)
        {
        ...
        //    double denominator = controlPoints[nextIndex].time - controlPoints[index].time;
        //    double intervalTime;

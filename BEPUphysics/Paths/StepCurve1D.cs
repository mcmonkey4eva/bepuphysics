namespace BEPUphysics.Paths
{
    ...
    /// </summary>
    public class StepCurve1D : Curve<double>
    {
        /// <summary>
        ...
        public override void Evaluate(int controlPointIndex, double weight, out double value)
        {
        ...
        protected internal override void ControlPointAdded(CurveControlPoint<double> curveControlPoint, int index)
        {
        }

        protected internal override void ControlPointRemoved(CurveControlPoint<double> curveControlPoint, int oldIndex)
        {
        }

        protected internal override void ControlPointTimeChanged(CurveControlPoint<double> curveControlPoint, int oldIndex, int newIndex)
        {
        }

        protected internal override void ControlPointValueChanged(CurveControlPoint<double> curveControlPoint)
        {
        }
    }
}
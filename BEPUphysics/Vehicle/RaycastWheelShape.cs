...
namespace BEPUphysics.Vehicle
{
    ...
    {
        private double graphicalRadius;
        ...
        public RaycastWheelShape(double graphicalRadius, Matrix localGraphicTransform)
        {
        ...
        public override void UpdateWorldTransform()
        {
            ...
            double length = wheel.suspension.currentLength - graphicalRadius;

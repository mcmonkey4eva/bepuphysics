...
namespace BEPUphysics.Vehicle
{
    ...
    public class CylinderCastWheelShape : WheelShape
    {
        ...
        public CylinderCastWheelShape(double radius, double width, Quaternion localWheelOrientation, Matrix localGraphicTransform, bool includeSteeringTransformInCast)
        {
        ...
        /// </summary>
        public override sealed double Radius
        {
        ...
        public override void UpdateWorldTransform()
        {
            ...
            double length = wheel.suspension.currentLength;
        ...
        protected internal override bool FindSupport(out Vector3 location, out Vector3 normal, out double suspensionLength, out Collidable supportingCollidable, out Entity entity, out Material material)
        {
            suspensionLength = double.MaxValue;

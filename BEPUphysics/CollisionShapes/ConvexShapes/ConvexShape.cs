...
namespace BEPUphysics.CollisionShapes.ConvexShapes
{
    ...
    public abstract class ConvexShape : EntityShape
    {
        ...
        protected internal double collisionMargin = CollisionDetectionSettings.DefaultMargin;
        ///<summary>
        ...
        /// </summary>
        public double MinimumRadius { get; internal set; }
        ...
        /// </summary>
        public double MaximumRadius { get; internal set; }
        ...
        public void GetExtremePoint(Vector3 direction, ref RigidTransform shapeTransform, out Vector3 extremePoint)
        {
            ...
            {
                Vector3.Multiply(ref direction, collisionMargin / (double)Math.Sqrt(directionLength), out direction);
        ...
        public virtual bool RayTest(ref Ray ray, ref RigidTransform transform, double maximumLength, out RayHit hit)
        {

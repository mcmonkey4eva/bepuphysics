...
namespace BEPUutilities
{
    ...
    public struct Matrix2x2
    {
        ...
        public static void CreateScale(double scale, out Matrix2x2 matrix)
        {
            matrix.M11 = scale;
            matrix.M22 = scale;
        ...
        public static void Invert(ref Matrix2x2 matrix, out Matrix2x2 result)
        {
            ...
            double m11 = matrix.M22 * determinantInverse;
            double m12 = -matrix.M12 * determinantInverse;

            double m21 = -matrix.M21 * determinantInverse;
            double m22 = matrix.M11 * determinantInverse;
        ...
        {
            double resultM11 = a.M11 * b.M11 + a.M12 * b.M21;
            double resultM12 = a.M11 * b.M12 + a.M12 * b.M22;

            double resultM21 = a.M21 * b.M11 + a.M22 * b.M21;
            double resultM22 = a.M21 * b.M12 + a.M22 * b.M22;
